...
export default async function TermsOfService() {
    return (
        <div className="my-12">
            <div>
                <p>These terms of service were last updated on March 16, 2024.</p>
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Agreement</h1>
                <p className="my-4">
                    By accessing this Website, accessible from pastepad.link, you are
                ...
                <p className="my-4">
                    Pastepad reserves the right to remove or disable any account or any
                ...
                <p className="my-4">While using the Services, you agree that you will not:</p>
                <ol>
                    <li>
                        harass, abuse, threaten, or incite violence towards any individual
                        or group, including other Users and Pastepad contributors;
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        falsely associate yourself with Pastepad;
                    </li>
                    <li>
                ...
                <p className="my-4">
                    ...
                    content anywhere on the Services that violates any laws. Pastepad
                ...
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Privacy Policy</h1>
                <p className="my-4">If you use our Services, you must abide by our Privacy Policy. You
                    acknowledge that you have read our</p>
                <a href="https://pastepad.link/privacy-policy" target="_blank" rel="noreferrer noopener">
                    Privacy Policy
                </a>
                ...
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Limitations on Automated Use</h1>
                <p className="my-4">You shouldn't use bots or access our Services in malicious or prohibited
                    ways. While accessing or using the Services, you may not:</p>
                <ol type="1">
                    <li>use bots, hacks, or cheats while using our site;</li>
                    <li>create manual requests to Pastepad servers;</li>
                    <li>
                        tamper with or use non-public areas of the Services, or the computer
                        or delivery systems of Pastepad and/or its service providers;
                    </li>
                    <li>
                        ...
                        provided by Pastepad (and only pursuant to those terms and
                        conditions), unless you have been specifically allowed to do so in a
                        separate agreement with Pastepad, Inc., or unless specifically
                        permitted by Pastepad, Inc.'s robots.txt file or other robot
                ...
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Links</h1>
                <p className="my-4">
                    Pastepad is not responsible for the contents of any linked sites. The
                    use of any linked website is at the user's own risk.
                </p>
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Changes</h1>
                <p className="my-4">
                    Pastepad may revise these Terms of Service for its Website at any time
                    without prior notice. By using this Website, you are agreeing to be
                    bound by the current version of these Terms of Service.
                </p>
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Disclaimer</h1>
                <p className="my-4">
                    ...
                    TO THE FULL EXTENT PERMITTED BY LAW, Pastepad DISCLAIMS ALL
                    ...
                    BE THE MINIMUM PERMITTED UNDER SUCH LAW. Pastepad MAKES NO
                    ...
                    COMPONENTS. Pastepad ALSO MAKES NO REPRESENTATIONS OR WARRANTIES OF
                    ...
                    FROM Pastepad OR THROUGH THE SERVICES, WILL CREATE ANY WARRANTY NOT
                    EXPRESSLY MADE HEREIN. Pastepad DOES NOT WARRANT, ENDORSE,
                    ...
                    Pastepad WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR
                ...
                <h1 className="text-3xl text-[var(--main-color)] mt-12">Contact</h1>
                <p className="my-4">
                    If you have any questions about Pastepad’s privacy policy, the data
                    we hold on you, or you would like to exercise one of your data
                    protection rights, please do not hesitate to contact us.
                </p>
                <p className="my-4">
                    Email: <a href="mailto:navaneethsai1999@gmail.com" target="_blank" rel="noopener noreferrer">
                        navaneethsai1999@gmail.com
                    </a>
                </p>
                Discord: @navaneethnivol
            </div>
            <p>
                Terms based on <a href="https://glitch.com/legal" target="_blank" rel="noreferrer noopener">
                    Glitch terms
                </a>
            </p>
        </div>
